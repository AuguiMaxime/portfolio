      ...
      <div className="about-inner">
        ...
        <div className="about-grid">
          ...
          <div className="about-right">
            ...
            <p className="about-text">
              En 6 mois de formation intensive, j'ai acquis une stack complète : React et Node.js côté full-stack. Depuis, j'ai élargi mes compétences au développement mobile avec React Native et Expo, jusqu'à la publication d'une application sur le Google Play Store. Je suis capable de travailler des heures sans voir le temps passer.
            </p>
            <p className="about-text">
